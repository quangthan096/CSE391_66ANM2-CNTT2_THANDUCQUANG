...
> - Điều này cho em biết JavaScript đang làm gì khi trang web được tải?
   JavaScript đang chạy và in thông báo ra console của trình duyệt.
---
...
JavaScript có thể chạy trong trình duyệt và trên server.
> b) HTML, CSS, JavaScript mỗi phần chịu trách nhiệm chính về điều gì?
>
> - HTML: tạo cấu trúc nội dung trang web
> - CSS: tạo kiểu dáng và giao diện cho trang web
> - JavaScript: tạo tương tác và xử lý logic cho trang web.
...
>   - `boolean` là: giá trị đúng hoặc sai (true / false)
...
Nếu điều kiện đúng thì chạy lệnh này, nếu sai thì chạy lệnh khác.
...
>   - Giá trị trả về (return): return
> - Ưu điểm của việc dùng hàm thay vì lặp lại cùng một đoạn code nhiều lần là gì?
Giúp tái sử dụng code, không phải viết lại nhiều lần.
---
...
Lấy phần tử HTML có id là status.
> - Sự kiện `"click"` xảy ra khi nào?
Người dùng nhấn chuột vào nút.
> - Trong đoạn code trên, khi nhấn nút `btnHello`, điều gì thay đổi trên trang?
Nội dung của đoạn <p> thay đổi bằng JavaScript.
---
...
"input": xảy ra khi gõ chữ vào ô input
...
>  DOM là mô hình cây của trang HTML, cho phép JavaScript truy cập và thay đổi nội dung trang web.
...
>   1. Cả hai đều dùng để xử lý sự kiện click và tương tác với DOM.
>   
>   2. Khác nhau
JS thuần:
